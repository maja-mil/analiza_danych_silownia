...
```
Porównanie spalonych kalorii między typami treningu
Na wykresie pudełkowym porównano rozkład spalonych kalorii (Calories_Burned) w zależności od typu treningu (Cardio, Siłowy, Joga, HIIT). Boxplot pokazuje medianę (linia w środku pudełka), rozstęp międzykwartylowy (pudełko) oraz wartości odstające (punkty).
...
```
Najsilniejsze korelacje między zmiennymi liczbowymi
W tabeli przedstawiono 10 najsilniejszych zależności liniowych między zmiennymi liczbowymi, mierzonych współczynnikiem korelacji Pearsona. Wartości dodatnie oznaczają, że wraz ze wzrostem jednej zmiennej rośnie druga, a wartości ujemne – że wzrost jednej wiąże się ze spadkiem drugiej. Należy podkreślić, że korelacja opisuje współwystępowanie i nie oznacza związku przyczynowo-skutkowego.
