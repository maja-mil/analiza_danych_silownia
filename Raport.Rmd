...
::: {style="text-align: justify"}
Analiza wykresów wykazuje, że wysoka częstotliwość treningów (5 sesji/tydz.) pełni przede wszystkim rolę stabilizującą parametry zdrowotne. Chociaż mediany BMI (24–25) i tętna spoczynkowego (ok. 61–63 BPM) są zbliżone we wszystkich grupach, to u osób trenujących najczęściej obserwujemy najmniejszy rozrzut danych i brak wartości skrajnych. Regularność działa więc jako mechanizm ochronny przed otyłością i wysokim tętnem spoczynkowym, przy czym jej bezpośredni wpływ na obniżenie średnich wyników jest zauważalny, lecz umiarkowany..
:::
