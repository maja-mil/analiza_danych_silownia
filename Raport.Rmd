...
Analiza regresji liniowej potwierdziła, że głównym czynnikiem determinującym liczbę spalonych kalorii jest czas trwania sesji (p < 0,001). Statystycznie nie stwierdzono istotnego wpływu rodzaju treningu ani jego interakcji z czasem trwania, co oznacza, że tempo spalania kalorii jest zbliżone dla wszystkich dyscyplin. Model uproszczony charakteryzował się wysokim dopasowaniem (R^2 = 0,825) i wskazał, że każda dodatkowa godzina ćwiczeń zwiększa wydatek energetyczny średnio o 722 kcal (ok. 12 kcal/min). Wniosek ten pozwala uznać czas trwania treningu za uniwersalny i najdokładniejszy miernik efektywności energetycznej w badanym zbiorze.
